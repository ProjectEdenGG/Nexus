...
@NoArgsConstructor
@Table(name = "kicks")
public class LiteBansKick extends LiteBansPunishment {
	@Id
	@GeneratedValue
	private long id;
	private String uuid;
	...
	@Override
	public String getRemoved_by_uuid() {
		return null;
	}

	@Override
	public String getRemoved_by_name() {
		return null;
	}

	@Override
	public Timestamp getRemoved_by_date() {
		return null;
	}
