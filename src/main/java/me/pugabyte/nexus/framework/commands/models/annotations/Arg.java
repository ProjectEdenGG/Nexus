...
public @interface Arg {
	...
	/**
	 * For arguments which require more context, like {@link me.pugabyte.nexus.features.minigames.models.Team}, you must
	 * set this value to point to the argument which provides the required context.
	 * <p>
	 * This value is one-indexed.
	 * </p>
	 * Example: for {@link me.pugabyte.nexus.features.minigames.models.Team} arguments, you must specify an Arena
	 ...
	 * @see me.pugabyte.nexus.features.minigames.commands.MinigamesCommand#convertToTeam(String, Arena) MinigamesCommand#convertToTeam(String, Arena)
	 * @see me.pugabyte.nexus.features.minigames.commands.MinigamesCommand#addSpawnpoint(Arena, Team) MinigamesCommand#addSpawnpoint(Arena, Team)
	 */
