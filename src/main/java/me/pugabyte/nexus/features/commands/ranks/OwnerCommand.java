...
public class OwnerCommand extends CustomCommand {
	...
	void owner() {
		line(5);
		send(Dev.PUGA.getNerd().getNicknameFormat() + "&3, &efounder &3of the server. Along with the " + Rank.ADMIN.getColor() + "Admin &3duties, he does most of the &eplugin &3management, " +
