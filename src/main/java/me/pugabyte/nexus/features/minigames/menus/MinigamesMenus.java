...
import me.pugabyte.nexus.features.minigames.menus.flags.BlockListMenu;
import me.pugabyte.nexus.features.minigames.menus.flags.FlagsMenu;
import me.pugabyte.nexus.features.minigames.menus.teams.TeamMenus;
...
public class MinigamesMenus extends MenuUtils {
	...
	public void openCustomSettingsMenu(Player player, Arena arena) {
		...
		customMenus:
		for (Class<? extends InventoryProvider> menu : new Reflections("me.pugabyte.nexus.features.minigames.menus.custom").getSubTypesOf(InventoryProvider.class)) {
