...
//	BREAK_1_MONSTER_SPAWNER(new BreakChallenge(new FuzzyItemStack(SPAWNER, 1))),
	...
	BREAK_DIFFERENT_TALL_FLOWERS(new BreakChallenge(new FuzzyItemStack(Set.of(PEONY, ROSE_BUSH, LILAC), 2))),
	...
	CRAFT_1_JUKEBOX(new CraftChallenge(new FuzzyItemStack(JUKEBOX, 1))),
	...
	CRAFT_1_CLOCK(new CraftChallenge(new FuzzyItemStack(CLOCK, 1))),
	...
	CRAFT_6_IRON_DOOR(new CraftChallenge(new FuzzyItemStack(IRON_DOOR, 32))),
	CRAFT_3_IRON_TRAPDOORS(new CraftChallenge(new FuzzyItemStack(IRON_TRAPDOOR, 32))),
	CRAFT_8_PISTONS(new CraftChallenge(new FuzzyItemStack(PISTON, 8))),
	CRAFT_1_DISPENSER(new CraftChallenge(new FuzzyItemStack(DISPENSER, 1))),
	CRAFT_16_SPECTRAL_ARROWS(new CraftChallenge(new FuzzyItemStack(SPECTRAL_ARROW, 16))),
	CRAFT_1_CROSSBOW(new CraftChallenge(new FuzzyItemStack(CROSSBOW, 1))),
	...
	CRAFT_1_LEATHER_HORSE_ARMOR(new CraftChallenge(new FuzzyItemStack(LEATHER_HORSE_ARMOR, 1))),
