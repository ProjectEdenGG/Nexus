...
public class DailyRewardsFeature {
	...
	private void setupDailyRewards() {
		...
		/* 42 */ rewards.add(new Reward("3 notch apples", new ItemStack(Material.GOLDEN_APPLE, 3, (short) 1)));
		...
		/* 54 */ rewards.add(new Reward("a zombie skull and a creeper skull", new ItemStack(Material.SKULL_ITEM, 1, (short) 2), new ItemStack(Material.SKULL_ITEM, 1, (short) 4)));
