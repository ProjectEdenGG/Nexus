...
//			/*   6 */ add(new R3ward("Set of iron tools")					.item());
...
//			/*  84 */ add(new R3ward("McMMo level coupon, 2 level")			.item(level coupon, 2 level, McMMo));
...
//			/*  87 */ add(new R3ward("iron, gold, diamond horse armour")	.item());
...
//			/*  94 */ add(new R3ward("McMMO level coupon 5 levels")			.item());
