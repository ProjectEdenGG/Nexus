...
public class MaterialTag implements Tag<Material> {
	...
	public static final MaterialTag PLANTS = new MaterialTag(GRASS, FERN, DEAD_BUSH,
			DANDELION, POPPY, BLUE_ORCHID, ALLIUM, AZURE_BLUET,
			RED_TULIP, ORANGE_TULIP, WHITE_TULIP, PINK_TULIP, OXEYE_DAISY,
			BROWN_MUSHROOM, RED_MUSHROOM, LILY_PAD, KELP, KELP_PLANT)
	...
	public static final MaterialTag NEEDS_SUPPORT = new MaterialTag(BAMBOO_SAPLING, BAMBOO, SEAGRASS, TALL_SEAGRASS, KELP, SUGAR_CANE,
			CACTUS, SEA_PICKLE, Material.SAND, RED_SAND, GRAVEL, GRASS, FERN, TALL_GRASS, LARGE_FERN, DEAD_BUSH, SWEET_BERRY_BUSH,
			BROWN_MUSHROOM, RED_MUSHROOM, CHORUS_PLANT, CHORUS_FLOWER, VINE, LILY_PAD, TURTLE_EGG, REPEATER, COMPARATOR, ITEM_FRAME,
			BELL, SNOW, SCAFFOLDING, TRIPWIRE_HOOK, LADDER, LEVER, END_ROD, TORCH, WALL_TORCH, REDSTONE_TORCH, REDSTONE_WALL_TORCH)
			.append(SAPLINGS, DOORS, SIGNS, RAILS, BEDS, BANNERS, FLOWERS, CONCRETE_POWDERS, SAND, CORALS, CARPETS,
					PRESSURE_PLATES, BUTTONS, FLOWER_POTS, ANVIL);
