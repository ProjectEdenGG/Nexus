...
public class MaterialTag implements Tag<Material> {
	...
	public static final MaterialTag REDSTONE_BLOCKS = new MaterialTag(REDSTONE_ACTIVATORS, DOORS, COMMAND_BLOCKS)
		.append(POWERED_RAIL, DETECTOR_RAIL, STICKY_PISTON, PISTON, REDSTONE_TORCH, REDSTONE_WALL_TORCH, REDSTONE_WIRE,
			TNT, DISPENSER, NOTE_BLOCK, REPEATER, TRIPWIRE_HOOK, TRAPPED_CHEST, COMPARATOR, REDSTONE_BLOCK, HOPPER,
			ACTIVATOR_RAIL, DROPPER, DAYLIGHT_DETECTOR);


	public static final MaterialTag NEEDS_SUPPORT = new MaterialTag(Material.GRAVEL, VINE, LILY_PAD, TURTLE_EGG,
		REPEATER, COMPARATOR, ITEM_FRAME, BELL, Material.SNOW, SCAFFOLDING, TRIPWIRE_HOOK, LADDER, LEVER, LANTERN, SOUL_LANTERN)
