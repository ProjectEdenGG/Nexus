...
public enum CustomMaterial {
	...
	COUNTER_STEEL_MARBLE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 5002),
	COUNTER_STEEL_MARBLE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 5003),
	COUNTER_STEEL_MARBLE_OVEN(Material.LEATHER_HORSE_ARMOR, 5004),
	COUNTER_STEEL_MARBLE_SINK(Material.LEATHER_HORSE_ARMOR, 5005),

	COUNTER_STEEL_SOAPSTONE_ISLAND(Material.LEATHER_HORSE_ARMOR, 5020),
	COUNTER_STEEL_SOAPSTONE_CORNER(Material.LEATHER_HORSE_ARMOR, 5021),
	COUNTER_STEEL_SOAPSTONE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 5022),
	COUNTER_STEEL_SOAPSTONE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 5023),
	COUNTER_STEEL_SOAPSTONE_OVEN(Material.LEATHER_HORSE_ARMOR, 5024),
	COUNTER_STEEL_SOAPSTONE_SINK(Material.LEATHER_HORSE_ARMOR, 5025),
	...
	COUNTER_BRASS_MARBLE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 5102),
	COUNTER_BRASS_MARBLE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 5103),
	COUNTER_BRASS_MARBLE_OVEN(Material.LEATHER_HORSE_ARMOR, 5104),
	COUNTER_BRASS_MARBLE_SINK(Material.LEATHER_HORSE_ARMOR, 5105),

	COUNTER_BRASS_SOAPSTONE_ISLAND(Material.LEATHER_HORSE_ARMOR, 5120),
	COUNTER_BRASS_SOAPSTONE_CORNER(Material.LEATHER_HORSE_ARMOR, 5121),
	COUNTER_BRASS_SOAPSTONE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 5122),
	COUNTER_BRASS_SOAPSTONE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 5123),
	COUNTER_BRASS_SOAPSTONE_OVEN(Material.LEATHER_HORSE_ARMOR, 5124),
	COUNTER_BRASS_SOAPSTONE_SINK(Material.LEATHER_HORSE_ARMOR, 5125),
	...
	COUNTER_BLACK_MARBLE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 5202),
	COUNTER_BLACK_MARBLE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 5203),
	COUNTER_BLACK_MARBLE_OVEN(Material.LEATHER_HORSE_ARMOR, 5204),
	COUNTER_BLACK_MARBLE_SINK(Material.LEATHER_HORSE_ARMOR, 5205),

	COUNTER_BLACK_SOAPSTONE_ISLAND(Material.LEATHER_HORSE_ARMOR, 5220),
	COUNTER_BLACK_SOAPSTONE_CORNER(Material.LEATHER_HORSE_ARMOR, 5221),
	COUNTER_BLACK_SOAPSTONE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 5222),
	COUNTER_BLACK_SOAPSTONE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 5223),
	COUNTER_BLACK_SOAPSTONE_OVEN(Material.LEATHER_HORSE_ARMOR, 5224),
	COUNTER_BLACK_SOAPSTONE_SINK(Material.LEATHER_HORSE_ARMOR, 5225),
