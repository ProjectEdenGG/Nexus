...
public enum CustomMaterial {
	...
	COUNTER_MARBLE_ISLAND(Material.LEATHER_HORSE_ARMOR, 1000),
	COUNTER_MARBLE_CORNER(Material.LEATHER_HORSE_ARMOR, 1001),
	COUNTER_MARBLE_DRAWER_HORIZONTAL(Material.LEATHER_HORSE_ARMOR, 1002),
	COUNTER_MARBLE_DRAWER_VERTICAL(Material.LEATHER_HORSE_ARMOR, 1003),
	COUNTER_MARBLE_OVEN(Material.LEATHER_HORSE_ARMOR, 1004),
	COUNTER_MARBLE_SINK(Material.LEATHER_HORSE_ARMOR, 1005),

	CABINET_WOODEN(Material.LEATHER_HORSE_ARMOR, 1100),
	CABINET_WOODEN_CORNER(Material.LEATHER_HORSE_ARMOR, 1101),
