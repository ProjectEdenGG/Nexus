...
public enum CustomMaterial {
	...
	EVENT_HEART_CRYSTAL(Material.PAPER, 11213),
	EVENT_LUCKY_HORSESHOE(Material.PAPER, 11214),
	EVENT_FISHING_POCKET_GUIDE(Material.PAPER, 11215),
	EVENT_WEATHER_RADIO(Material.PAPER, 11216),
	EVENT_SEXTANT(Material.PAPER, 11217),
	EVENT_DEPTH_METER(Material.PAPER, 11218),
	EVENT_GOLD_WATCH(Material.PAPER, 11219),
	EVENT_FISH_FINDER(Material.PAPER, 11220),
	EVENT_GPS(Material.PAPER, 11221),

	EVENT_COMPASS(Material.COMPASS, 1),
