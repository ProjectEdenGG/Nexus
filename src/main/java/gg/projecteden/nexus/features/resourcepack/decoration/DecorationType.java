...
// 	------------------------------------------------------------------------------------------------------
	...
	DRUM_KIT(new DyeableInstrument(true, "Drum Kit", CustomMaterial.DRUM_KIT, InstrumentSound.DRUM_KIT, ColorableType.DYE, HitboxUnique.DRUM_KIT, InstrumentType.FLOOR )),

	@TypeConfig(price = 2250, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	PIANO_GRAND(new DyeableInstrument(true, "Grand Piano", CustomMaterial.PIANO_GRAND, InstrumentSound.GRAND_PIANO, ColorableType.STAIN, HitboxUnique.PIANO_GRAND, InstrumentType.FLOOR )),

	@TypeConfig(price = 750, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	PIANO_KEYBOARD(new DyeableInstrument(true, "Keyboard", CustomMaterial.PIANO_KEYBOARD, InstrumentSound.PIANO, ColorableType.DYE, HitboxFloor._1x2H_LIGHT, InstrumentType.FLOOR )),

	@TypeConfig(price = 900, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	PIANO_KEYBOARD_ON_STAND(new DyeableInstrument(true, "Keyboard On Stand", CustomMaterial.PIANO_KEYBOARD_ON_STAND, InstrumentSound.PIANO, ColorableType.DYE, HitboxFloor._1x2H, InstrumentType.FLOOR )),

	@TypeConfig(price = 1050, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	HARP(new Instrument(false, "Harp", CustomMaterial.HARP, InstrumentSound.HARP, HitboxFloor._1x2V, InstrumentType.FLOOR )),

	@TypeConfig(price = 900, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	BONGOS(new DyeableInstrument(true, "Bongos", CustomMaterial.BONGOS, InstrumentSound.BONGOS, ColorableType.DYE, HitboxFloor._1x2H, InstrumentType.FLOOR )),
...
// 	------------------------------------------------------------------------------------------------------
	...
	FLORA_BUSHY_PLANT(new DyeableFloorThing(false, "Bushy Plant", CustomMaterial.FLORA_BUSHY_PLANT, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 225, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_POTTED_CHERRY_TREE(new DyeableFloorThing(false, "Potted Cherry Tree", CustomMaterial.FLORA_POTTED_CHERRY_TREE, ColorableType.DYE, HitboxSingle._1x1_HEAD )),

	@TypeConfig(price = 165, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_POTTED_BAY_TREE(new DyeableFloorThing(false, "Potted Bay Tree", CustomMaterial.FLORA_POTTED_BAY_TREE, ColorableType.DYE, HitboxFloor._1x2V )),

	@TypeConfig(price = 135, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_SNAKE_PLANT(new DyeableFloorThing(false, "Snake Plant", CustomMaterial.FLORA_SNAKE_PLANT, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 135, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_WHITE_BIRD_PARADISE(new DyeableFloorThing(false, "White Bird of Paradise", CustomMaterial.FLORA_WHITE_BIRD_PARADISE, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 210, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_BONSAI(new DyeableFloorThing(false, "Bonsai", CustomMaterial.FLORA_BONSAI, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 210, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_BONSAI_CHERRY(new DyeableFloorThing(false, "Cherry Bonsai", CustomMaterial.FLORA_BONSAI_CHERRY, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 140, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_BONSAI_SMALL(new DyeableFloorThing(false, "Small Bonsai", CustomMaterial.FLORA_BONSAI_SMALL, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 140, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_BONSAI_CHERRY_SMALL(new DyeableFloorThing(false, "Small Cherry Bonsai", CustomMaterial.FLORA_BONSAI_CHERRY_SMALL, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 75, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_CHINESE_EVERGREEN(new DyeableFloorThing(false, "Chinese Evergreen", CustomMaterial.FLORA_CHINESE_EVERGREEN, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 135, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_FLOWER_VASE(new DyeableFloorThing(false, "Flower Vase", CustomMaterial.FLORA_FLOWER_VASE, ColorableType.DYE, HitboxSingle.NONE )),

	@TypeConfig(price = 105, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_WALL_FLOWERS_1(new DyeableWallThing(false, "Wall Flowers", CustomMaterial.FLORA_WALL_FLOWERS_1, ColorableType.DYE, HitboxSingle._1x1 )),

	@TypeConfig(price = 95, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_POTTED_TULIPS(new DyeableFloorThing(false, "Potted Tulips", CustomMaterial.FLORA_POTTED_TULIPS, ColorableType.DYE, HitboxSingle._1x1_HEAD )),
...
// 	------------------------------------------------------------------------------------------------------
	...
	WARDROBE(new Furniture(true, "Wardrobe", CustomMaterial.WARDROBE, FurnitureSurface.FLOOR, HitboxFloor._2x3V )),

	@TypeConfig(price = 240, tabs = Tab.FURNITURE)
	CUPBOARD_SHORT_DOUBLE(new Furniture(true, "Short Cupboard Double", CustomMaterial.CUPBOARD_SHORT_DOUBLE, FurnitureSurface.FLOOR, HitboxFloor._1x2H )),

	@TypeConfig(price = 120, tabs = Tab.FURNITURE)
	CUPBOARD_SHORT_SINGLE(new Furniture(false, "Short Cupboard Single", CustomMaterial.CUPBOARD_SHORT_SINGLE, FurnitureSurface.FLOOR, HitboxSingle._1x1 )),

	@TypeConfig(price = 240, tabs = Tab.FURNITURE)
	CUPBOARD_SHORT_BOOKSHELF_DOUBLE(new Furniture(true, "Short Bookshelf Cupboard Double", CustomMaterial.CUPBOARD_SHORT_BOOKSHELF_DOUBLE, FurnitureSurface.FLOOR, HitboxFloor._1x2H )),

	@TypeConfig(price = 120, tabs = Tab.FURNITURE)
	CUPBOARD_SHORT_BOOKSHELF_SINGLE(new Furniture(false, "Short Bookshelf Cupboard Single", CustomMaterial.CUPBOARD_SHORT_BOOKSHELF_SINGLE, FurnitureSurface.FLOOR, HitboxSingle._1x1 )),
...
// 	------------------------------------------------------------------------------------------------------
	...
	SHELF_STORAGE(new Furniture(true, "Storage Shelf", CustomMaterial.SHELF_STORAGE, FurnitureSurface.FLOOR, HitboxFloor._2x3V )),
