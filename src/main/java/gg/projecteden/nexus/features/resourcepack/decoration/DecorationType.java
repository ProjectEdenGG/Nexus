...
//										CATALOG: Holiday
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(money = 550, tokens = -1, theme = Theme.HOLIDAY, tabs = Tab.FIREPLACES)
	...
	@TypeConfig(money = 150, tokens = -1, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 300, tokens = -1, theme = Theme.HOLIDAY)
	SNOWMAN_PLAIN(new FloorThing(false, "Plain Snowman", CustomMaterial.SNOWMAN_PLAIN, HitboxFloor._1x2V)),

	@TypeConfig(money = 375, tokens = -1, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 90, tokens = -1, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 185, tokens = -1, theme = Theme.HOLIDAY)
...
//										CATALOG: Spooky
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(money = 75, tokens = -1, theme = Theme.SPOOKY)
	GRAVESTONE_SMALL(new FloorThing(false, "Small Gravestone", CustomMaterial.GRAVESTONE_SMALL)),

	@TypeConfig(money = 150, tokens = -1, theme = Theme.SPOOKY)
	...
	@TypeConfig(money = 225, tokens = -1, theme = Theme.SPOOKY)
...
// 	------------------------------------------------------------------------------------------------------
	// - Noisemakers
	@TypeConfig(money = 1500, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 2250, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 750, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 900, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 1050, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 675, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 750, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 600, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 450, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 195, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 375, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 285, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 525, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 155, tokens = -1, theme = Theme.MUSIC)
...
//										CATALOG: Pride
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(money = 75, tokens = -1, theme = Theme.PRIDE, tabs = Tab.PRIDE_FLAGS)
	...
	// Pride Bunting
	@TypeConfig(money = 45, tokens = -1, theme = Theme.PRIDE, tabs = Tab.PRIDE_BUNTING)
...
// 	------------------------------------------------------------------------------------------------------
	//	Windchimes
	@TypeConfig(money = 150, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_IRON(new WindChime("Iron Windchimes", WindChimeType.IRON)),

	@TypeConfig(money = 300, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_GOLD(new WindChime("Gold Windchimes", WindChimeType.GOLD)),

	@TypeConfig(money = 225, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_COPPER(new WindChime("Copper Windchimes", WindChimeType.COPPER)),

	@TypeConfig(money = 900, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	...
	@TypeConfig(money = 3000, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_NETHERITE(new WindChime("Netherite Windchimes", WindChimeType.NETHERITE)),

	@TypeConfig(money = 1500, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_DIAMOND(new WindChime("Diamond Windchimes", WindChimeType.DIAMOND)),

	@TypeConfig(money = 600, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_REDSTONE(new WindChime("Redstone Windchimes", WindChimeType.REDSTONE)),

	@TypeConfig(money = 1050, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	...
	// 	Birdhouses
	@TypeConfig(money = 150, tokens = -1, theme = Theme.OUTDOORS)
	...
	// Flora
	@TypeConfig(money = 120, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_BUSHY_PLANT(new Flora(false, "Bushy Plant", CustomMaterial.FLORA_BUSHY_PLANT, HitboxSingle.NONE, PlacementType.FLOOR)),

	@TypeConfig(money = 225, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 165, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 135, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 210, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 140, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 75, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 105, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 165, tokens = -1, theme = Theme.OUTDOORS)
...
// 	------------------------------------------------------------------------------------------------------
	//	Custom
	@TypeConfig(money = 300, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 150, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 600, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 450, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 900, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	// Vanilla
	@TypeConfig(money = 150, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	ART_PAINTING_VANILLA_FRIEND(new Art("Friend", CustomMaterial.ART_PAINTING_VANILLA_FRIEND, HitboxWall._1x1_LIGHT, true)),

	@TypeConfig(money = 300, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(money = 600, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(money = 1200, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(money = 1800, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
...
// 	------------------------------------------------------------------------------------------------------
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	@TypeConfig(money = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	CHAIR_CLOTH(new DyeableChair(false, false, "Cloth Chair", CustomMaterial.CHAIR_CLOTH, ColorableType.DYE)),

	@TypeConfig(money = 135, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	// 	Stools
	@TypeConfig(money = 90, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	STOOL_WOODEN_BASIC(new DyeableChair(false, true, "Wooden Stool", CustomMaterial.STOOL_WOODEN_BASIC, ColorableType.STAIN)),

	@TypeConfig(money = 120, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	STOOL_BAR_WOODEN(new DyeableChair(false, true, "Wooden Bar Stool", CustomMaterial.STOOL_BAR_WOODEN, ColorableType.STAIN, 1.15)),

	// Stumps
	@TypeConfig(money = 60, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STUMPS})
	STUMP_OAK(new Stump(false, "Oak Stump", CustomMaterial.STUMP_OAK)),

	@TypeConfig(money = 75, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STUMPS})
	...
	// 	Benches
	@TypeConfig(money = 225, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	// Flags
	@TypeConfig(money = 75, tokens = -1, tabs = Tab.FLAGS)
	FLAG_SERVER(new Flag(false, "Server Flag", CustomMaterial.FLAG_SERVER)),

	// Bunting
	@TypeConfig(money = 60, tokens = -1, tabs = {Tab.FLAGS, Tab.BUNTING})
	...
	@TypeConfig(money = 30, tokens = -1, tabs = {Tab.FLAGS, Tab.BUNTING})
	...
	@TypeConfig(money = 75, tokens = -1, tabs = {Tab.FLAGS, Tab.BUNTING})
	BUNTING_SERVER_LOGO(new Bunting(true, "Server Logo Bunting", CustomMaterial.BUNTING_SERVER_LOGO)),

	// Banners
	// 	Hanging
	@TypeConfig(money = 120, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	@TypeConfig(money = 105, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	@TypeConfig(money = 90, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	//	Standing
	@TypeConfig(money = 90, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_STANDING})
	BANNER_STANDING_SERVER_LOGO(new StandingBanner("Server Logo Standing Banner", CustomMaterial.BANNER_STANDING_SERVER_LOGO)),

	// 	Fireplaces
	@TypeConfig(money = 525, tokens = -1, tabs = {Tab.FURNITURE, Tab.FIREPLACES})
	...
	//	Food
	@TypeConfig(money = 45, tokens = -1, tabs = Tab.FOOD)
	...
	@TypeConfig(money = 25, tokens = -1, tabs = Tab.FOOD)
	...
	@TypeConfig(money = 90, tokens = -1, tabs = Tab.FOOD)
	...
	//	Kitchenware
	@TypeConfig(money = 45, tokens = -1, tabs = Tab.KITCHENWARE)
	WINE_BOTTLE(new FloorThing(false, "Wine Bottle", CustomMaterial.KITCHENWARE_WINE_BOTTLE)),

	@TypeConfig(money = 90, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(money = 30, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(money = 75, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(money = 60, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	// 	Appliances
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 270, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 285, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 90, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 105, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(money = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(money = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	@TypeConfig(money = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	// Cabinets - GENERIC
	@TypeConfig(money = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS})
	CABINET_HOOD(new WallThing(false, "Hood Cabinet", CustomMaterial.CABINET_HOOD, HitboxSingle._1x1_BARRIER)),

	@TypeConfig(money = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS})
	...
	@TypeConfig(money = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS})
	...
	@TypeConfig(money = 225, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 120, tokens = -1, tabs = Tab.FURNITURE)
	...
	@TypeConfig(money = 215, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 430, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 235, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 470, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 255, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 510, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	//	Potions
	@TypeConfig(money = 45, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 60, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 75, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 90, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 105, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 120, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 65, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 30, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 54, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 135, tokens = -1)
	HELM(new DecorationConfig(false, "Helm", CustomMaterial.HELM)),

	@TypeConfig(money = 60, tokens = -1)
