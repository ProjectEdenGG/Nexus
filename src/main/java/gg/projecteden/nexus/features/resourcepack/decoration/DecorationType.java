...
public enum DecorationType {
	...
	CHAIR_BEACH(CatalogTab.CHAIRS, new Chair("Beach Chair", CustomMaterial.BEACH_CHAIR, Type.DYE, List.of(Hitbox.origin(Material.FLOWER_POT), Hitbox.offset(Material.FLOWER_POT, BlockFace.SOUTH)), .675)),
	// 	Stools
