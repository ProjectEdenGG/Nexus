...
//										CATALOG: Holiday
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(money = 550, theme = Theme.HOLIDAY, tabs = Tab.FIREPLACES)
	...
	@TypeConfig(money = 150, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 500, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 90, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 185, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 70, theme = Theme.HOLIDAY, tabs = Tab.ORNAMENTS)
	...
	@TypeConfig(money = 140, theme = Theme.HOLIDAY, tabs = Tab.GIANT_ORNAMENTS)
	...
	@TypeConfig(money = 200, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 120, theme = Theme.HOLIDAY)
	...
	@TypeConfig(money = 200, theme = Theme.HOLIDAY, tabs = Tab.PRESENTS)
	PRESENT_SHORT_DOUBLE_RED(new Present(PresentType.SHORT_DOUBLE_RED)),

	@TypeConfig(money = 160, theme = Theme.HOLIDAY, tabs = Tab.PRESENTS)
	PRESENT_MINI_RED(new Present(PresentType.MINI_RED)),

	@TypeConfig(money = 120, theme = Theme.HOLIDAY, tabs = Tab.PRESENTS)
	PRESENT_BLOCK_RED(new Present(PresentType.BLOCK_RED)),

	@TypeConfig(money = 250, theme = Theme.HOLIDAY, tabs = Tab.PRESENTS)
	...
	@TypeConfig(money = 360, theme = Theme.HOLIDAY)
...
// 	------------------------------------------------------------------------------------------------------
	...
	@TypeConfig(money = 225, theme = Theme.SPOOKY)
	...
	@TypeConfig(money = 215, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_BEDS})
	...
	@TypeConfig(money = 225, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_CHAIRS})
	SPOOKY_BENCH_WOODEN(new Bench(true, false, "Spooky Wooden Bench", ItemModelType.BENCH_SPOOKY, HitboxFloor._1x2H)),

	@TypeConfig(money = 120, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_CHAIRS})
	...
	@TypeConfig(money = 150, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_CHAIRS})
	...
	@TypeConfig(money = 80, theme = Theme.SPOOKY)
	...
	@TypeConfig(money = 225, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_TABLES})
	SPOOKY_TABLE_WOODEN_2x3(new Table(TableTheme.SPOOKY_WOODEN, TableShape._2X3, ItemModelType.TABLE_WOODEN_2X3_SPOOKY)),

	@TypeConfig(money = 185, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_TABLES})
	...
	@TypeConfig(money = 300, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_TABLES})
	SPOOKY_TABLE_WOODEN_3x3(new Table(TableTheme.SPOOKY_WOODEN, TableShape._3X3, ItemModelType.TABLE_WOODEN_3X3_SPOOKY)),

	@TypeConfig(money = 275, theme = Theme.SPOOKY, tabs = {Tab.SPOOKY_FURNITURE, Tab.SPOOKY_TABLES})
	...
	@TypeConfig(money = 250, theme = Theme.SPOOKY, tabs = Tab.SPOOKY_FURNITURE)
	...
	@TypeConfig(money = 125, theme = Theme.SPOOKY, tabs = Tab.SPOOKY_FURNITURE)
	...
	@TypeConfig(money = 450, theme = Theme.SPOOKY, tabs = Tab.SPOOKY_FURNITURE)
	...
	@TypeConfig(money = 900, theme = Theme.SPOOKY, tabs = Tab.ART)
	...
	@TypeConfig(money = 600, theme = Theme.SPOOKY, tabs = Tab.ART)
...
// 	------------------------------------------------------------------------------------------------------
	// - Noisemakers
	@TypeConfig(money = 1500, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 2250, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 750, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 900, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 1050, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(money = 675, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 750, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 600, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 450, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 195, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 375, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 285, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 525, theme = Theme.MUSIC)
	...
	@TypeConfig(money = 155, theme = Theme.MUSIC)
...
//										CATALOG: Pride
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(money = 75, theme = Theme.PRIDE, tabs = Tab.PRIDE_FLAGS)
	...
	// Pride Bunting
	@TypeConfig(money = 45, theme = Theme.PRIDE, tabs = Tab.PRIDE_BUNTING)
...
// 	------------------------------------------------------------------------------------------------------
	//	Windchimes
	@TypeConfig(money = 150, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_IRON(new WindChime("Iron Windchimes", WindChimeType.IRON)),

	@TypeConfig(money = 300, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_GOLD(new WindChime("Gold Windchimes", WindChimeType.GOLD)),

	@TypeConfig(money = 225, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_COPPER(new WindChime("Copper Windchimes", WindChimeType.COPPER)),

	@TypeConfig(money = 900, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	...
	@TypeConfig(money = 3000, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_NETHERITE(new WindChime("Netherite Windchimes", WindChimeType.NETHERITE)),

	@TypeConfig(money = 1500, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_DIAMOND(new WindChime("Diamond Windchimes", WindChimeType.DIAMOND)),

	@TypeConfig(money = 600, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_REDSTONE(new WindChime("Redstone Windchimes", WindChimeType.REDSTONE)),

	@TypeConfig(money = 1050, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	...
	// 	Birdhouses
	@TypeConfig(money = 150, theme = Theme.OUTDOORS)
	...
	@TypeConfig(money = 165, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 135, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 210, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 140, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 75, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(money = 105, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_WALL_FLOWERS_1(new Flora(false, "Wall Flowers", ItemModelType.FLORA_WALL_FLOWERS_1, PlacementType.WALL)),

	@TypeConfig(money = 95, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	// Stumps
	@TypeConfig(money = 60, theme = Theme.OUTDOORS, tabs = Tab.STUMPS)
	STUMP_OAK(new Stump(false, "Oak Stump", ItemModelType.STUMP_OAK)),

	@TypeConfig(money = 75, theme = Theme.OUTDOORS, tabs = Tab.STUMPS)
...
// 	------------------------------------------------------------------------------------------------------
	//	Custom
	@TypeConfig(money = 300, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 150, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 600, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 450, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(money = 900, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	// Vanilla
	@TypeConfig(money = 150, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	ART_PAINTING_VANILLA_FRIEND(new Art("Friend", ItemModelType.ART_PAINTING_VANILLA_FRIEND, HitboxWall._1x1_LIGHT, true)),

	@TypeConfig(money = 300, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(money = 600, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(money = 1200, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(money = 1800, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
...
// 	------------------------------------------------------------------------------------------------------
	...
	@TypeConfig(money = 195, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	CHAIR_CLOTH(new DyeableChair(false, false, "Cloth Chair", ItemModelType.CHAIR_CLOTH, ColorableType.DYE)),

	@TypeConfig(money = 135, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	// 	Stools
	@TypeConfig(money = 90, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	STOOL_WOODEN_BASIC(new DyeableChair(false, true, "Wooden Stool", ItemModelType.STOOL_WOODEN_BASIC, ColorableType.STAIN)),

	@TypeConfig(money = 120, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	// Flags
	@TypeConfig(money = 75, tabs = Tab.FLAGS)
	FLAG_SERVER(new Flag(false, "Server Flag", ItemModelType.FLAG_SERVER)),

	// Bunting
	@TypeConfig(money = 60, tabs = {Tab.FLAGS, Tab.BUNTING})
	...
	@TypeConfig(money = 30, tabs = {Tab.FLAGS, Tab.BUNTING})
	...
	@TypeConfig(money = 75, tabs = {Tab.FLAGS, Tab.BUNTING})
	BUNTING_SERVER_LOGO(new Bunting(true, "Server Logo Bunting", ItemModelType.BUNTING_SERVER_LOGO)),

	// Banners
	// 	Hanging
	@TypeConfig(money = 120, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	@TypeConfig(money = 105, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	@TypeConfig(money = 90, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	//	Standing
	@TypeConfig(money = 90, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_STANDING})
	BANNER_STANDING_SERVER_LOGO(new StandingBanner("Server Logo Standing Banner", ItemModelType.BANNER_STANDING_SERVER_LOGO)),

	// 	Fireplaces
	@TypeConfig(money = 525, tabs = {Tab.FURNITURE, Tab.FIREPLACES})
	...
	//	Food
	@TypeConfig(money = 45, tabs = Tab.FOOD)
	...
	@TypeConfig(money = 25, tabs = Tab.FOOD)
	...
	@TypeConfig(money = 90, tabs = Tab.FOOD)
	...
	@TypeConfig(money = 30, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(money = 75, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(money = 60, tabs = Tab.KITCHENWARE)
	...
	// 	Appliances
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 195, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 270, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 285, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 90, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 105, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(money = 165, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(money = 195, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(money = 195, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	@TypeConfig(money = 195, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	// Cabinets - GENERIC
	@TypeConfig(money = 195, tabs = {Tab.FURNITURE, Tab.CABINETS})
	CABINET_HOOD(new WallThing(false, "Hood Cabinet", ItemModelType.CABINET_HOOD, HitboxSingle._1x1_BARRIER)),

	@TypeConfig(money = 180, tabs = {Tab.FURNITURE, Tab.CABINETS})
	...
	@TypeConfig(money = 150, tabs = {Tab.FURNITURE, Tab.CABINETS})
	...
	@TypeConfig(money = 225, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(money = 120, tabs = Tab.FURNITURE)
	...
	@TypeConfig(money = 215, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 430, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 235, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 470, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 255, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(money = 510, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	//	Potions
	@TypeConfig(money = 45, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 60, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 75, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 90, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 105, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 120, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 65, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 30, tabs = Tab.POTIONS)
	...
	@TypeConfig(money = 54, tabs = Tab.POTIONS)
...
// 	------------------------------------------------------------------------------------------------------
	...
	// Type Config
	@SneakyThrows
	private TypeConfig _getTypeConfig() {
		return this.getClass().getField(this.name()).getAnnotation(TypeConfig.class);
	}

	public boolean hasTypeConfig() {
		return _getTypeConfig() != null;
	}

	public Catalog.Tab[] getTypeConfigTabs() {
		return _getTypeConfig().tabs();
	}

	public int getTypeConfigMoney() {
		return TypeConfigPricing.money(_getTypeConfig());
	}

	public int getTypeConfigTokens() {
		return TypeConfigPricing.tokens(_getTypeConfig());
	}

	public Theme getTypeConfigTheme() {
		return _getTypeConfig().theme();
	}

	public boolean isBuyable() {
		return !_getTypeConfig().unbuyable();
	}
	//
	...
	public static Map<Tab, List<DecorationType>> getTabTypeMap() {
		...
		for (DecorationType type : values()) {
			if (type.hasTypeConfig()) {
				Tab[] tabs = type.getTypeConfigTabs();
				if (tabs.length != 0)
	...
	public static Map<Tab, List<Tab>> getSubTabMap() {
		...
		for (DecorationType type : values()) {
			...
			if (type.hasTypeConfig()) {
				var tabs = type.getTypeConfigTabs();
				if (tabs.length != 0) {
					List<Tab> tabsList = new ArrayList<>(List.of(tabs));
					tab = tabsList.removeFirst();
					subTabs.addAll(tabsList);
				}
			}
	...
	public static CategoryTree getCategoryTree() {
		...
		for (DecorationType type : values()) {
			...
			TypeConfig typeConfig = type._getTypeConfig();
