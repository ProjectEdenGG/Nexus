...
//										CATALOG: Holiday
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(price = 550, tokens = -1, theme = Theme.HOLIDAY, tabs = Tab.FIREPLACES)
	...
	@TypeConfig(price = 150, tokens = -1, theme = Theme.HOLIDAY)
	...
	@TypeConfig(price = 300, tokens = -1, theme = Theme.HOLIDAY)
	SNOWMAN_PLAIN(new FloorThing(false, "Plain Snowman", CustomMaterial.SNOWMAN_PLAIN, HitboxFloor._1x2V)),

	@TypeConfig(price = 375, tokens = -1, theme = Theme.HOLIDAY)
	...
	@TypeConfig(price = 90, tokens = -1, theme = Theme.HOLIDAY)
	...
	@TypeConfig(price = 185, tokens = -1, theme = Theme.HOLIDAY)
...
//										CATALOG: Spooky
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(price = 75, tokens = -1, theme = Theme.SPOOKY)
	GRAVESTONE_SMALL(new FloorThing(false, "Small Gravestone", CustomMaterial.GRAVESTONE_SMALL)),

	@TypeConfig(price = 150, tokens = -1, theme = Theme.SPOOKY)
	...
	@TypeConfig(price = 225, tokens = -1, theme = Theme.SPOOKY)
...
// 	------------------------------------------------------------------------------------------------------
	// - Noisemakers
	@TypeConfig(price = 1500, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(price = 2250, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(price = 750, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(price = 900, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(price = 1050, tokens = -1, theme = Theme.MUSIC, tabs = Tab.MUSIC_NOISEMAKERS)
	...
	@TypeConfig(price = 675, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 750, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 600, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 450, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 195, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 375, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 285, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 525, tokens = -1, theme = Theme.MUSIC)
	...
	@TypeConfig(price = 155, tokens = -1, theme = Theme.MUSIC)
...
//										CATALOG: Pride
// 	------------------------------------------------------------------------------------------------------
	@TypeConfig(price = 75, tokens = -1, theme = Theme.PRIDE, tabs = Tab.PRIDE_FLAGS)
	...
	// Pride Bunting
	@TypeConfig(price = 45, tokens = -1, theme = Theme.PRIDE, tabs = Tab.PRIDE_BUNTING)
...
// 	------------------------------------------------------------------------------------------------------
	//	Windchimes
	@TypeConfig(price = 150, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_IRON(new WindChime("Iron Windchimes", WindChimeType.IRON)),

	@TypeConfig(price = 300, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_GOLD(new WindChime("Gold Windchimes", WindChimeType.GOLD)),

	@TypeConfig(price = 225, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_COPPER(new WindChime("Copper Windchimes", WindChimeType.COPPER)),

	@TypeConfig(price = 900, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	...
	@TypeConfig(price = 3000, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_NETHERITE(new WindChime("Netherite Windchimes", WindChimeType.NETHERITE)),

	@TypeConfig(price = 1500, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_DIAMOND(new WindChime("Diamond Windchimes", WindChimeType.DIAMOND)),

	@TypeConfig(price = 600, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	WINDCHIME_REDSTONE(new WindChime("Redstone Windchimes", WindChimeType.REDSTONE)),

	@TypeConfig(price = 1050, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.WINDCHIMES)
	...
	// 	Birdhouses
	@TypeConfig(price = 150, tokens = -1, theme = Theme.OUTDOORS)
	...
	// Flora
	@TypeConfig(price = 120, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_BUSHY_PLANT(new Flora(false, "Bushy Plant", CustomMaterial.FLORA_BUSHY_PLANT, HitboxSingle.NONE, PlacementType.FLOOR)),

	@TypeConfig(price = 225, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(price = 165, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(price = 135, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(price = 210, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(price = 140, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(price = 75, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	...
	@TypeConfig(price = 105, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
	FLORA_WALL_FLOWERS_1(new Flora(false, "Wall Flowers", CustomMaterial.FLORA_WALL_FLOWERS_1, PlacementType.WALL)),

	@TypeConfig(price = 95, tokens = -1, theme = Theme.OUTDOORS, tabs = Tab.FLORA)
...
// 	------------------------------------------------------------------------------------------------------
	//	Custom
	@TypeConfig(price = 300, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(price = 150, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(price = 600, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(price = 450, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	@TypeConfig(price = 900, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_CUSTOM})
	...
	// Vanilla
	@TypeConfig(price = 150, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	ART_PAINTING_VANILLA_FRIEND(new Art("Friend", CustomMaterial.ART_PAINTING_VANILLA_FRIEND, HitboxWall._1x1_LIGHT, true)),

	@TypeConfig(price = 300, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(price = 600, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(price = 1200, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
	...
	@TypeConfig(price = 1800, tokens = -1, theme = Theme.ART, tabs = {Tab.ART_VANILLA})
...
// 	------------------------------------------------------------------------------------------------------
	...
	@TypeConfig(price = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	CHAIR_CLOTH(new DyeableChair(false, false, "Cloth Chair", CustomMaterial.CHAIR_CLOTH, ColorableType.DYE)),

	@TypeConfig(price = 135, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	// 	Stools
	@TypeConfig(price = 90, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	STOOL_WOODEN_BASIC(new DyeableChair(false, true, "Wooden Stool", CustomMaterial.STOOL_WOODEN_BASIC, ColorableType.STAIN)),

	@TypeConfig(price = 120, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STOOLS})
	STOOL_BAR_WOODEN(new DyeableChair(false, true, "Wooden Bar Stool", CustomMaterial.STOOL_BAR_WOODEN, ColorableType.STAIN, 1.15)),

	// Stumps
	@TypeConfig(price = 60, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STUMPS})
	STUMP_OAK(new Stump(false, "Oak Stump", CustomMaterial.STUMP_OAK)),

	@TypeConfig(price = 75, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS, Tab.STUMPS})
	...
	// 	Benches
	@TypeConfig(price = 225, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.CHAIRS})
	...
	// Flags
	@TypeConfig(price = 75, tokens = -1, tabs = Tab.FLAGS)
	FLAG_SERVER(new Flag(false, "Server Flag", CustomMaterial.FLAG_SERVER)),

	// Bunting
	@TypeConfig(price = 60, tokens = -1, tabs = {Tab.FLAGS, Tab.BUNTING})
	...
	@TypeConfig(price = 30, tokens = -1, tabs = {Tab.FLAGS, Tab.BUNTING})
	...
	@TypeConfig(price = 75, tokens = -1, tabs = {Tab.FLAGS, Tab.BUNTING})
	BUNTING_SERVER_LOGO(new Bunting(true, "Server Logo Bunting", CustomMaterial.BUNTING_SERVER_LOGO)),

	// Banners
	// 	Hanging
	@TypeConfig(price = 120, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	@TypeConfig(price = 105, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	@TypeConfig(price = 90, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_HANGING})
	...
	//	Standing
	@TypeConfig(price = 90, tokens = -1, tabs = {Tab.FLAGS, Tab.BANNERS, Tab.BANNERS_STANDING})
	BANNER_STANDING_SERVER_LOGO(new StandingBanner("Server Logo Standing Banner", CustomMaterial.BANNER_STANDING_SERVER_LOGO)),

	// 	Fireplaces
	@TypeConfig(price = 525, tokens = -1, tabs = {Tab.FURNITURE, Tab.FIREPLACES})
	...
	//	Food
	@TypeConfig(price = 45, tokens = -1, tabs = Tab.FOOD)
	...
	@TypeConfig(price = 25, tokens = -1, tabs = Tab.FOOD)
	...
	@TypeConfig(price = 90, tokens = -1, tabs = Tab.FOOD)
	...
	//	Kitchenware
	@TypeConfig(price = 45, tokens = -1, tabs = Tab.KITCHENWARE)
	WINE_BOTTLE(new FloorThing(false, "Wine Bottle", CustomMaterial.KITCHENWARE_WINE_BOTTLE)),

	@TypeConfig(price = 90, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(price = 30, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(price = 75, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	@TypeConfig(price = 60, tokens = -1, tabs = Tab.KITCHENWARE)
	...
	// 	Appliances
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 270, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 285, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 90, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 105, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.STEEL_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BRASS_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.MARBLE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.SOAPSTONE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.STONE_COUNTER})
	...
	@TypeConfig(price = 165, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.COUNTERS_MENU, Tab.BLACK_HANDLES, Tab.WOODEN_COUNTER})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(price = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.STEEL_HANDLES})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(price = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BRASS_HANDLES})
	...
	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	@TypeConfig(price = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS, Tab.BLACK_HANDLES})
	...
	// Cabinets - GENERIC
	@TypeConfig(price = 195, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS})
	CABINET_HOOD(new WallThing(false, "Hood Cabinet", CustomMaterial.CABINET_HOOD, HitboxSingle._1x1_BARRIER)),

	@TypeConfig(price = 180, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS})
	...
	@TypeConfig(price = 150, tokens = -1, tabs = {Tab.FURNITURE, Tab.CABINETS})
	...
	@TypeConfig(price = 225, tokens = -1, tabs = {Tab.FURNITURE, Tab.APPLIANCES})
	...
	@TypeConfig(price = 120, tokens = -1, tabs = Tab.FURNITURE)
	...
	@TypeConfig(price = 215, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(price = 430, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(price = 235, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(price = 470, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(price = 255, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	@TypeConfig(price = 510, tokens = -1, tabs = {Tab.FURNITURE, Tab.BEDS})
	...
	//	Potions
	@TypeConfig(price = 45, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 60, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 75, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 90, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 105, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 120, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 65, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 30, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 54, tokens = -1, tabs = Tab.POTIONS)
	...
	@TypeConfig(price = 135, tokens = -1)
	HELM(new DecorationConfig(false, "Helm", CustomMaterial.HELM)),

	@TypeConfig(price = 60, tokens = -1)
