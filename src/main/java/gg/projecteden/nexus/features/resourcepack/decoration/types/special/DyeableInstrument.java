...
public class DyeableInstrument extends DyeableFloorThing implements NoiseMaker {
	...
	public DyeableInstrument(String name, CustomMaterial material, String sound, ColorableType type, CustomHitbox hitbox) {
		this(name, material, sound, type, null, hitbox.getHitboxes());
	}
