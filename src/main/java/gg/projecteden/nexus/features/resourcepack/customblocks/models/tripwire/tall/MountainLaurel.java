...
@CustomBlockConfig(
	...
	itemModel = ItemModelType.FLORA_MOUNTAIN_LAUREL_ITEM
)
...
public class MountainLaurel implements ITall, ICraftable, IRequireDirt {

	@Override
	public @Nullable RecipeBuilder<?> getUncraftRecipe() {
		return getUncraftRecipe(Material.WHITE_DYE, 1);
	}
}
