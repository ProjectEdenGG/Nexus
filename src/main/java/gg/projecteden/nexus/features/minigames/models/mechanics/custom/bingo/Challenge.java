...
public enum Challenge {
	...
	CRAFT_32_POLISHED_BLACKSTONE_BRICKS(new CraftChallenge(new FuzzyItemStack(Material.POLISHED_BLACKSTONE_BRICKS, 32))),
	CRAFT_A_CAKE(new CraftChallenge(new FuzzyItemStack(Material.CAKE, 1))),
	CRAFT_8_DRIED_KELP_BLOCKS(new CraftChallenge(new FuzzyItemStack(Material.DRIED_KELP_BLOCK, 8))),
	CRAFT_16_ITEM_FRAMES(new CraftChallenge(new FuzzyItemStack(Material.ITEM_FRAME, 16))),
	// 1.17 + mob spawn fix? CRAFT_4_GLOW_ITEM_FRAMES(new CraftChallenge(new FuzzyItemStack(GLOW_ITEM_FRAME))),
	CRAFT_64_CHISELED_STONE_BRICKS(new CraftChallenge(new FuzzyItemStack(Material.CHISELED_STONE_BRICKS, 64))), // TODO Do I need to worry about stonecutters?
	CRAFT_3_BLAST_FURNACES(new CraftChallenge(new FuzzyItemStack(Material.BLAST_FURNACE, 3))),
	CRAFT_16_SOUL_CAMPFIRES(new CraftChallenge(new FuzzyItemStack(Material.SOUL_CAMPFIRE, 16))),
	CRAFT_32_POLISHED_BASALT(new CraftChallenge(new FuzzyItemStack(Material.POLISHED_BASALT, 32))),
	CRAFT_12_BOOKS(new CraftChallenge(new FuzzyItemStack(Material.BOOK, 12))),
	CRAFT_2_BOOKSHELVES(new CraftChallenge(new FuzzyItemStack(Material.BOOKSHELF, 2))),
	CRAFT_2_LECTERNS(new CraftChallenge(new FuzzyItemStack(Material.LECTERN, 2))),
	CRAFT_2_DAYLIGHT_DETECTORS(new CraftChallenge(new FuzzyItemStack(Material.DAYLIGHT_DETECTOR, 2))),
	CRAFT_2_OBSERVER(new CraftChallenge(new FuzzyItemStack(Material.OBSERVER, 2))),
	...
	CRAFT_1_TNT(new CraftChallenge(new FuzzyItemStack(Material.TNT, 1))),
	CRAFT_2_LOOMS(new CraftChallenge(new FuzzyItemStack(Material.LOOM, 2))),
	CRAFT_A_FLOWER_BANNER_PATTERN(new CraftChallenge(new FuzzyItemStack(Material.FLOWER_BANNER_PATTERN, 1))),
	CRAFT_3_BANNERS(new CraftChallenge(new FuzzyItemStack(MaterialTag.ALL_BANNERS, 3))),
	CRAFT_AN_ANVIL(new CraftChallenge(new FuzzyItemStack(Material.ANVIL, 1))),
	CRAFT_2_CAULDRONS(new CraftChallenge(new FuzzyItemStack(Material.CAULDRON, 2))),
	CRAFT_3_HOPPERS(new CraftChallenge(new FuzzyItemStack(Material.HOPPER, 3))),
	...
	CRAFT_8_PISTONS(new CraftChallenge(new FuzzyItemStack(Material.PISTON, 8))),
	CRAFT_A_DISPENSER(new CraftChallenge(new FuzzyItemStack(Material.DISPENSER, 1))),
	CRAFT_16_SPECTRAL_ARROWS(new CraftChallenge(new FuzzyItemStack(Material.SPECTRAL_ARROW, 16))),
	CRAFT_A_CROSSBOW(new CraftChallenge(new FuzzyItemStack(Material.CROSSBOW, 1))),
	CRAFT_1_JACK_O_LANTERN(new CraftChallenge(new FuzzyItemStack(Material.JACK_O_LANTERN, 1))),
	CRAFT_64_STAINED_GLASS_PANES(new CraftChallenge(new FuzzyItemStack(MaterialTag.STAINED_GLASS_PANES, 64))),
	CRAFT_2_GOLDEN_CARROTS(new CraftChallenge(new FuzzyItemStack(Material.GOLDEN_CARROT, 2))),
	CRAFT_2_GLISTERING_MELON_SLICES(new CraftChallenge(new FuzzyItemStack(Material.GLISTERING_MELON_SLICE, 2))),
	CRAFT_2_FLETCHING_TABLES(new CraftChallenge(new FuzzyItemStack(Material.FLETCHING_TABLE, 2))),
	CRAFT_A_LEATHER_HORSE_ARMOR(new CraftChallenge(new FuzzyItemStack(Material.LEATHER_HORSE_ARMOR, 1))),
	CRAFT_2_PUMPKIN_PIE(new CraftChallenge(new FuzzyItemStack(Material.PUMPKIN_PIE, 2))),
	CRAFT_63_WOOD(new CraftChallenge(new FuzzyItemStack(MaterialTag.ALL_WOOD, 63))),
	CRAFT_3_BONE_BLOCK(new CraftChallenge(new FuzzyItemStack(Material.BONE_BLOCK, 3))),
	CRAFT_12_GLASS_BOTTLES(new CraftChallenge(new FuzzyItemStack(Material.GLASS_BOTTLE, 12))),
	CRAFT_4_SNOW_BLOCKS(new CraftChallenge(new FuzzyItemStack(Material.SNOW_BLOCK, 4))),
	...
	// Statistic Increase
	WALK_1_KILOMETER(new StatisticIncreaseChallenge(Material.DIAMOND_BOOTS, Statistic.WALK_ONE_CM, 100000)),
	BOAT_2_KILOMETERS(new StatisticIncreaseChallenge(Material.OAK_BOAT, Statistic.BOAT_ONE_CM, 200000)),
	BREAK_A_WOODEN_PICKAXE(new StatisticIncreaseChallenge(Material.WOODEN_PICKAXE, Statistic.BREAK_ITEM, Material.WOODEN_PICKAXE, 1)),

	// Custom
	// TODO Better way to do this?
	SPAWN_AN_IRON_GOLEM(new CustomChallenge(Material.IRON_BLOCK, CustomTask.SPAWN_AN_IRON_GOLEM)),
	SPAWN_A_SNOW_GOLEM(new CustomChallenge(Material.SNOW_BLOCK, CustomTask.SPAWN_A_SNOW_GOLEM)),
	CLIMB_TO_BUILD_HEIGHT(new CustomChallenge(Material.BLUE_CONCRETE, CustomTask.CLIMB_TO_BUILD_HEIGHT)),
	DIG_TO_BEDROCK(new CustomChallenge(Material.BEDROCK, CustomTask.DIG_TO_BEDROCK)),
