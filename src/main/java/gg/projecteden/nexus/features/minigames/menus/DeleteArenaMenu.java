...
public class DeleteArenaMenu extends InventoryProvider {
	...
	public void init(Player player, InventoryContents contents) {
		...
		contents.fillRect(0, 0, 2, 8, ClickableItem.of(cancelItem, e -> new ArenaMenu(arena).open(player)));
		contents.fillRect(1, 1, 1, 7, ClickableItem.of(cancelItem, e -> new ArenaMenu(arena).open(player)));
