...
import gg.projecteden.nexus.features.ambience.effects.particles.common.ParticleEffectConfig;
...
public class ParticleEffectManager extends AmbienceManager {
	...
	public void onStart() {
		...
		effects.add(new ParticleEffectConfig(ParticleEffectType.FALLING_LEAVES, Material.MANGROVE_LEAVES, Material.MANGROVE_LEAVES, null, Material.AIR, 5));
