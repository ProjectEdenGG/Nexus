...
//		send(json("&3[+] &c/jobs").hover("&3").suggest("/jobs")); // TODO Jobs
	...
	void set(Banker banker, BigDecimal balance, @Optional("server") TransactionCause cause, String reason, @Switch  @Optional("current") ShopGroup world) {
	...
	@Description("Modify a player's balance")
	@Permission(Group.ADMIN)
	void give(Banker banker, BigDecimal balance, @Optional("server") TransactionCause cause, String reason, @Switch @Optional("current") ShopGroup world) {
	...
	@Description("Modify a player's balance")
	@Permission(Group.ADMIN)
	void take(Banker banker, BigDecimal balance, @Optional("server") TransactionCause cause, String reason, @Switch @Optional("current") ShopGroup world) {
