...
public enum ChatGameType {
	...
	public static final Set<String> WORDS = new HashSet<>() {{
		...
		// doesnt work --> exploded the server
//		addAll(Enchant.getReleasedValues().stream().map(enchant -> AdventureUtils.asPlainText(enchant.displayName(1)).replace(" I", "")).toList());
	...
	public enum TriviaQuestion {
		...
		// Geography
		LITHUANIA_BORDER_NORTH("What country borders Lithuania to the north?", "Latvia"),
		SLOVAKIA_BORDER_SOUTH("What country borders Slovakia to the south?", "Hungary"),
		ARMENIA_BORDER_EAST("What country borders Armenia to the east?", "Azerbaijan"),
		FRANCE_SPAIN_BETWEEN("What country is between France and Spain?", "Andorra"),
		MOST_BORDERS("Name one of the two countries that border the most countries in the world", List.of("Russia", "China")),
		MOST_BORDERS_COUNT("How many countries do Russia and China border?", getNumberAnswers(14)),
		SURROUNDED_BY_SOUTH_AFRICA("What country is completely surrounded by South Africa?", "Lesotho"),
		MOST_NATURAL_LAKES("What country has the most natural lakes?", "Canada"),
		HOME_KILIMANJARO("What country is home to Mount Kilimanjaro?", "Tanzania"),
		CITY_DUBROVNIK("What country has the city of Dubrovnik?", "Croatia"),
		CITY_BERLIN("What country has the city of Budapest?", "Hungary"),
		CITY_JAKARTA("What country has the city of Jakarta?", "Indonesia"),
		CITY_VIENNA("What country has the city of Vienna?", "Austria"),
		CITY_LISBON_COUNTRY("What country has the city of Lisbon?", "Portugal"),
		CITY_COPENHAGEN("What country has the city of Copenhagen?", "Denmark"),
		COUNTRY_MOUNT_FUJI("What country is home to Mount Fuji?", "Japan"),

		CAPITAL_AUSTRALIA("What is the capital city of Australia?", "Canberra"),
		CAPITAL_JAPAN("What is the capital of Japan?", "Tokyo"),
		CAPITAL_EGYPT("What is the capital of Egypt?", "Cairo"),
		CAPITAL_CANADA("What is the capital of Canada?", "Ottawa"),
		CAPITAL_ICELAND("What is the capital of Iceland?", "Reykjavik"),
		CAPITAL_BRAZIL("What is the capital of Brazil?", "Brasilia"),
		CAPITAL_SWITZERLAND("What is the capital of Switzerland?", "Bern"),
		CAPITAL_SOUTH_KOREA("What is the capital of South Korea?", "Seoul"),
		CAPITAL_ARGENTINA("What is the capital of Argentina?", "Buenos Aires"),
		CAPITAL_KENYA("What is the capital of Kenya?", "Nairobi"),
		CAPITAL_THAILAND("What is the capital of Thailand?", "Bangkok"),
		CAPITAL_PORTUGAL("What is the capital of Portugal?", "Lisbon"),
		CAPITAL_HUNGARY("What is the capital of Hungary?", "Budapest"),
		CAPITAL_FINLAND("What is the capital of Finland?", "Helsinki"),
		CAPITAL_NEW_ZEALAND("What is the capital of New Zealand?", "Wellington"),
		CAPITAL_NIGERIA("What is the capital of Nigeria?", "Abuja"),
		CAPITAL_CHILE("What is the capital of Chile?", "Santiago"),
		...
		LARGEST_COUNTRY_SOUTH_AMERICA("What is the largest country in South America by land mass?", "Brazil"),
		LARGEST_CITY_TURKEY("What is the largest city in Turkey?", "Istanbul"),
		LARGEST_LAKE_AFRICA("What is the largest lake in Africa?", "Lake Victoria"),
		LARGEST_GULF("What is the largest gulf in the world?", "Gulf of Mexico"),
		SMALLEST_COUNTRY("What is the smallest country in the world by land mass?", "Vatican City"),
		SECOND_LARGEST_COUNTRY("What is the second largest country in the world by land mass?", "Canada"),
		SECOND_SMALLEST_COUNTRY("What is the second smallest country in the world by land mass?", "Monaco"),
		SMALLEST_CONTINENT("What is the smallest continent in the world?", "Australia"),
		DEEPEST_LAKE("What is the deepest lake in the world?", "Lake Baikal"),

		URALS_SEPARATE_CONTINENTS("What mountain range separates Europe and Asia?", List.of("Ural", "Ural Mountains")),
		OCEAN_BETWEEN_AF_AU("What ocean is between Africa and Australia?", "Indian Ocean"),
		MADAGASCAR_CONTINENT("What continent is Madagascar part of?", "Africa"),
		COUNTRY_AND_CONTINENT("What is the only country that is also a continent?", "Australia"),
		ARABIA_AFRICA_SEA("What body of water separates the Arabian Peninsula and Africa?", "Red Sea"),

		TALLEST_MOUNTAIN_EUROPE("What is the tallest mountain in Europe?", "Mount Elbrus"),
		TALLEST_MOUNTAIN_AFRICA("What is the tallest mountain in Africa?", "Mount Kilimanjaro"),
		TALLEST_MOUNTAIN_NORTH_AMERICA("What is the tallest mountain in North America?", "Denali"),
		TALLEST_MOUNTAIN_SOUTH_AMERICA("What is the tallest mountain in South America?", "Aconcagua"),
		TALLEST_MOUNTAIN_WORLD("What is the tallest mountain in the world?", "Mount Everest"),
		;
