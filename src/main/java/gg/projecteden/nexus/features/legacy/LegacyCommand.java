...
//		}
//
//		private CompletableFuture<ItemStack[]> getInventory(WorldGroup group) {
//			return getProfile(group).thenApply(survivalData -> {
...
//		}
//
//		private CompletableFuture<ItemStack[]> getEnderChest(WorldGroup group) {
//			return getProfile(group).thenApply(survivalData -> {
...
//		}
//
//		private CompletableFuture<ItemStack[]> getArmor(WorldGroup group) {
//			return getProfile(group).thenApply(survivalData -> {
...
//		}
//
//		private CompletableFuture<ItemStack> getOffHand(WorldGroup group) {
//			return getProfile(group).thenApply(survivalData -> {
...
//		}
//
//		public CompletableFuture<PlayerProfile> getProfile(WorldGroup group) {
//			var survivalGroup = Nexus.getMultiverseInventories().getWorldGroupManager().getGroup(StringUtils.camelCase(group));
...
//				Nexus.getMultiverseInventories().getProfileDataSource().updatePlayerProfile(legacy);
//				Nexus.getMultiverseInventories().getProfileDataSource().updatePlayerProfile(survival);
//			});
//		});
//
