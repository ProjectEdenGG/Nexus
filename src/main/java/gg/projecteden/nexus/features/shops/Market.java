...
public class Market {
	...
	private static void addItems() {
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.GRANITE, 1, 0.70);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COPPER_ORE, 1, 6);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.REDSTONE_ORE, 1, 6);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_COAL_ORE, 1, 6);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_IRON_ORE, 1, 25);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_GOLD_ORE, 1, 40);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_LAPIS_ORE, 1, 60);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_REDSTONE_ORE, 1, 6);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COARSE_DIRT, 1, 0.50);
