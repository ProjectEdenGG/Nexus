...
public class Market {
	...
	*/
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.TERRACOTTA, 1, 1.25);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.CLAY, 1, 1.25);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.CLAY_BALL, 1, 0.3);
...
//		addBuyItem(ShopGroup.SURVIVAL, true, Material.MYCELIUM, 1, 6.5);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.CALCITE, 1, 2.5);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COAL_ORE, 1, 5);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.IRON_ORE, 1, 12);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.GOLD_ORE, 1, 20);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.LAPIS_ORE, 1, 28);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.REDSTONE_ORE, 1, 12);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COPPER_ORE, 1, 7.5);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DIAMOND_ORE, 1, 60);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.EMERALD_ORE, 1, 110);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_COAL_ORE, 1, 12);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_IRON_ORE, 1, 17);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_GOLD_ORE, 1, 35);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_LAPIS_ORE, 1, 40);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_REDSTONE_ORE, 1, 22);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_COPPER_ORE, 1, 12);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_DIAMOND_ORE, 1, 80);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_EMERALD_ORE, 1, 160);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COAL, 1, 1.25);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.RAW_IRON, 1, 3);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.RAW_GOLD, 1, 4.5);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.LAPIS_LAZULI, 1, 0.25);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.REDSTONE, 1, 2);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.RAW_COPPER, 1, 0.25);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DIAMOND, 1, 15);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.EMERALD, 1, 30);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.QUARTZ, 1, 1.25);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.ANCIENT_DEBRIS, 1, 340);
...
//		addBuyItem(ShopGroup.SURVIVAL, true, Material.AMETHYST_SHARD, 1, .5);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.HAY_BLOCK, 1, 15);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.LILY_PAD, 1, 10);
	...
	private static void addSellItem(ShopGroup shopGroup, boolean isResourceWorld, ItemStack item, double price) {
		add(new Product(UUIDUtils.UUID0, shopGroup, isResourceWorld, item, -1, ExchangeType.SELL, price));
	}
	...
	private static void addBuyItem(ShopGroup shopGroup, boolean isResourceWorld, ItemStack item, double price) {
		final Product product = new Product(UUIDUtils.UUID0, shopGroup, isResourceWorld, item, -1, ExchangeType.BUY, price * BoostConfig.multiplierOf(Boostable.MARKET_SELL_PRICES));
