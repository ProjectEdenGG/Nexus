...
public class Market {
	...
	*/
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.CLAY, 1, 1);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.CLAY_BALL, 1, 0.25);
...
//		addBuyItem(ShopGroup.SURVIVAL, true, Material.MYCELIUM, 1, 6.5);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.IRON_ORE, 1, 15);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.GOLD_ORE, 1, 20);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.LAPIS_ORE, 1, 35);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.REDSTONE_ORE, 1, 14);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COPPER_ORE, 1, 8.50);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DIAMOND_ORE, 1, 70);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.EMERALD_ORE, 1, 120);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_COAL_ORE, 1, 9);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_IRON_ORE, 1, 20);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_GOLD_ORE, 1, 45);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_LAPIS_ORE, 1, 55);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_REDSTONE_ORE, 1, 20);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_COPPER_ORE, 1, 12.50);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_DIAMOND_ORE, 1, 90);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.DEEPSLATE_EMERALD_ORE, 1, 160);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.COAL, 1, 2);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.RAW_IRON, 1, 4);
		addBuyItem(ShopGroup.SURVIVAL, true, Material.RAW_GOLD, 1, 5);
		...
		addBuyItem(ShopGroup.SURVIVAL, true, Material.ANCIENT_DEBRIS, 1, 325);
