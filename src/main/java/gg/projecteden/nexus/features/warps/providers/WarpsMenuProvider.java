	...
	public void init(Player player, InventoryContents contents) {
		...
		switch (menu) {
			...
			case MINIGAMES -> {
				...
				contents.set(1, 4, ClickableItem.from(lobby, e -> warp(player, "minigames")));
				contents.set(1, 2, ClickableItem.from(parkour, e -> warp(player, "parkour")));
				contents.set(1, 6, ClickableItem.from(arcade, e -> warp(player, "arcade")));
			}
			case OTHER -> {
				...
				contents.set(1, 1, ClickableItem.from(leaderboards, e -> warp(player, "podiums")));
				...
				contents.set(2, 4, ClickableItem.from(storetesting, e -> warp(player, "store")));
			...
			case BUILD_CONTESTS -> {
				...
				contents.set(1, 6, ClickableItem.from(contest6, e -> warp(player, "buildcontest6")));
				contents.set(1, 7, ClickableItem.from(contest7, e -> warp(player, "buildcontest7")));
				contents.set(1, 8, ClickableItem.from(contest8, e -> warp(player, "buildcontest8")));
				contents.set(2, 0, ClickableItem.from(contest9, e -> warp(player, "buildcontest9")));
			}
		}
	}
