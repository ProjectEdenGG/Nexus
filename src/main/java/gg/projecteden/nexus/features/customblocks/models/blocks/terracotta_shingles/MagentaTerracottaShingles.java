...
public class MagentaTerracottaShingles implements ICustomBlock, IDyeable {
	@Override
	...
	public @NonNull String getName() {
		return "Magenta Terracotta Shingles";
	}
	...
	public @Nullable Pair<RecipeBuilder<?>, Integer> getCraftRecipe() {
		return get2x2Recipe(Material.MAGENTA_TERRACOTTA);
	}

	@Override
	public @Nullable RecipeBuilder<?> getUncraftRecipe() {
		return getUncraftRecipe(Material.MAGENTA_TERRACOTTA, 1);
	}
}
