...
public class BrownQuiltedWool implements ICustomBlock, IDyeable {
	@Override
	...
	public @Nullable Pair<RecipeBuilder<?>, Integer> getCraftRecipe() {
		return get2x2Recipe(Material.BROWN_WOOL);
	}

	@Override
	public @Nullable RecipeBuilder<?> getUncraftRecipe() {
		return getUncraftRecipe(Material.BROWN_WOOL, 1);
	}
}
