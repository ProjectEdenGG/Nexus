...
public class LightBlueQuiltedWool implements ICustomBlock, IDyeable {
	@Override
	...
	public @NonNull String getName() {
		return "Light Blue Quilted Wool";
	}
	...
	public @Nullable Pair<RecipeBuilder<?>, Integer> getCraftRecipe() {
		return get2x2Recipe(Material.LIGHT_BLUE_WOOL);
	}

	@Override
	public @Nullable RecipeBuilder<?> getUncraftRecipe() {
		return getUncraftRecipe(Material.LIGHT_BLUE_WOOL, 1);
	}
}
