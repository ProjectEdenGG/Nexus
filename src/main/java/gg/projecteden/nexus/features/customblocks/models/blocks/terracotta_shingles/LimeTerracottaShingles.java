...
public class LimeTerracottaShingles implements ICustomBlock, IDyeable {
	@Override
	...
	public @Nullable Pair<RecipeBuilder<?>, Integer> getCraftRecipe() {
		return get2x2Recipe(Material.LIME_TERRACOTTA);
	}

	@Override
	public @Nullable RecipeBuilder<?> getUncraftRecipe() {
		return getUncraftRecipe(Material.LIME_TERRACOTTA, 1);
	}
}
