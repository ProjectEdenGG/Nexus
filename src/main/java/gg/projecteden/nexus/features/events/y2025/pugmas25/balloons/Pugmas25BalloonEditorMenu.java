...
// TODO RELEASE: ADD FULL BACKGROUND
@Rows(5)
public class Pugmas25BalloonEditorMenu extends InventoryProvider {
	...
	private static final ItemBuilder EDITOR_EXIT = new ItemBuilder(ItemModelType.GUI_TRASHCAN).name("Exit").lore("&c(Will not save your progress)").dyeColor(ColorType.RED).itemFlags(ItemFlags.HIDE_ALL);
