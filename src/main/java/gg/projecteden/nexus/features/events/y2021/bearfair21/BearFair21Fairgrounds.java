...
import gg.projecteden.nexus.features.events.y2021.bearfair21.fairgrounds.reflection.BearFair21ReflectionGame;
...
public class BearFair21Fairgrounds implements Listener {

	public BearFair21Fairgrounds() {
		Nexus.registerListener(this);
		new Timer("        BF21.Fairgrounds.Interactables", BearFair21Interactables::new);
		new Timer("        BF21.Fairgrounds.Rides", BearFair21Rides::new);
		new Timer("        BF21.Fairgrounds.Minigolf", BearFair21MiniGolf::new);
		new Timer("        BF21.Fairgrounds.Archery", BearFair21Archery::new);
		new Timer("        BF21.Fairgrounds.Frogger", BearFair21Frogger::new);
		new Timer("        BF21.Fairgrounds.Seeker", BearFair21Seeker::new);
		new Timer("        BF21.Fairgrounds.Reflection", BearFair21ReflectionGame::new);
	}
