...
public class Pugmas25BalloonManager {
	protected static final String REGION_BASE = Pugmas25.get().getRegionName() + "_balloon_";
	protected static final String REGION_PLACEMENT_REGEX = REGION_BASE + "placement_[0-9]+";
	protected static final String DIRECTORY = "pugmas25/balloons/";
	protected static final String SCHEM_TEMPLATE = DIRECTORY + "template/";
	protected static final String SCHEM_USER = DIRECTORY + "user/";
	protected static final WorldEditUtils worldedit = Pugmas25.get().worldedit();
	protected static final WorldGuardUtils worldguard = Pugmas25.get().worldguard();
	//
