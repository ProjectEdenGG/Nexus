...
import gg.projecteden.nexus.features.events.y2024.pugmas24.fairgrounds.slotmachine.SlotMachineColumn.SlotMachineColumnStatus;
...
public class Pugmas24SlotMachine extends EdenEventSinglePlayerGame {
	...
	private static final String BASE_REGION = "pugmas24_slotmachine_";
	...
	public static Pugmas24SlotMachine get() {
		return instance;
	}
	...
	public void end() {
		...
		for (Material material : winningSherdMap.keySet()) {
			...
			if (count == halfCount) {
				...
				rewardType = Pugmas24SlotMachineRewardType.HALF;
				break;
			} else if (count == fullCount) {
				reward = Pugmas24SlotMachineReward.of(material);
				rewardType = Pugmas24SlotMachineRewardType.FULL;
				break;
			}
		}
