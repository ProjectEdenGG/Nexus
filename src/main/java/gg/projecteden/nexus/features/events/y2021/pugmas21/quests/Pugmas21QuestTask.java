...
public enum Pugmas21QuestTask implements IQuestTask {
	CRYSTAL_REPAIR_1(InteractQuestTask.builder()
		...
		.dialog(dialog -> dialog
			...
			.npc("Where are my manners, my name is " + Pugmas21NPC.GLORIA + " and welcome to Pugmas!")
			.player("Oh... ah, hey there! My name's " + Dialog.Variable.PLAYER_NAME + ". Is this weather normal for this time of year?")
		...
		.then()
		.talkTo(Pugmas21NPC.MYSTERIOUS_WOMAN)
		.dialog(dialog -> dialog
			.npc("Ohhh, what's this I see? A visitor? I haven't had one of those in a long time.")
			.player("Hello there, sorry to intrude. My name is " + Dialog.Variable.PLAYER_NAME + ", I was told that I might be able to find the guardian out here.")
	...
	CLEAR_SKIES(GatherQuestTask.builder()
		...
		.dialog(dialog -> dialog
			...
			.npc("Hurray! Oh " + Dialog.Variable.PLAYER_NAME + ", I just knew you'd help out.")
		...
		.dialog(dialog -> dialog
			...
			.npc("Get me 32 iron, and 64 crystal wood to start. You'll have to talk to " + Pugmas21NPC.FLINT + " in the mines and the lumberjack, " + Pugmas21NPC.WARREN + ".")
			.player("Got it!")
		)
		.then()
		.talkTo(Pugmas21NPC.FLINT)
		.dialog(dialog -> dialog
			.player("Hi! Are you " + Dialog.Variable.NPC_NAME + "?")
			...
			.player("Okay, awesome! Thanks " + Dialog.Variable.NPC_NAME + "!")
		...
		.then()
		.talkTo(Pugmas21NPC.WARREN)
		.dialog(dialog -> dialog
			.player("Excuse me, are you " + Dialog.Variable.NPC_NAME + " by any chance?")
			...
			.player("Thank you " + Dialog.Variable.NPC_NAME + "!")
		...
		.complete(dialog -> dialog
			...
			.npc("Go see " + Pugmas21NPC.WARREN + " about the wooden basket, ask " + Pugmas21NPC.ROWAN + " in the costume store about the fabric for the actual balloon, and you can mine up some coal for fuel; 64 should be enough.")
		)
		.then()
		.talkTo(Pugmas21NPC.WARREN)
		.dialog(dialog -> dialog
			.npc("Hey there, I wasn't expecting you back so soon.")
			.npc("When " + Pugmas21NPC.BELLAMY + " called saying I should be expecting their assistant to stop by I thought it would be someone else")
			...
			.npc("About that... " + Pugmas21NPC.BELLAMY + " hung up before I could explain that I'm completely out of oak logs at the moment")
			.npc("I'm far too busy to add another expedition into my schedule for a single request.")
			.npc("I was dreading having to turn " + Pugmas21NPC.BELLAMY + "'s assistant away after they made the trip all the way here, however considering it's you...")
		...
		.complete(dialog -> dialog
			.npc("Ah perfect! It's pretty good quality too. You sure you wanna continue being " + Pugmas21NPC.BELLAMY + "'s assistant? I could use someone like you working around the shop.")
			...
			.give(Pugmas21QuestItem.BALLOON_BASKET.get())
		...
		.dialog(dialog -> dialog
			...
			.npc("Oh, you're " + Pugmas21NPC.BELLAMY + "'s assistant! Why didn't you just say so? I have it right here for you.")
			...
			.give(Pugmas21QuestItem.BALLOON_ENVELOPE.get())
		...
		.gather(Pugmas21QuestItem.BALLOON_BASKET.get(), Pugmas21QuestItem.BALLOON_ENVELOPE.get())
		.complete(dialog -> dialog
			...
			.give(Pugmas21QuestItem.BALLOON.get())
		...
		.gather(Pugmas21QuestItem.BOTTLED_CLOUD.get())
		.complete(dialog -> dialog
		...
		.complete(dialog -> dialog
			...
			.npc("...")
			.npc("Still nothing...")
			.npc("I'm so sorry " + Dialog.Variable.PLAYER_NAME + ". I made you run all over the place for nothing.")
			...
			.give(Pugmas21QuestItem.CRYSTAL_PIECE.get())
...
//			.endCondition()
	...
	HOLIDAY_HEIST_PIRATES(GatherQuestTask.builder()
		.talkTo(Pugmas21NPC.CAPTAIN_NERISSA)
		.dialog(dialog -> dialog
			.npc("Mm. Okay, this is really not good.")
			.npc("Oh, " + Dialog.Variable.PLAYER_NAME + ", why are you just standing around? Come over here.")
		...
		.complete(dialog -> dialog
			...
			.give(Pugmas21QuestItem.ELF_EARS.get())
		...
		.then()
		.talkTo(Pugmas21NPC.PANSY)
		.gather(Pugmas21QuestItem.PUGMAS_COOKIE_RECIPE.get())
		.dialog(dialog -> dialog
			.npc("Oh, hey " + Dialog.Variable.PLAYER_NAME + "! I didn't expect to see you here.")
			.npc("What's that you're holding?")
			.player("It's a cookie recipe that I accidentally stol-, I mean stumbled upon while helping around the island. " + Pugmas21NPC.CAPTAIN_NERISSA + " thought you could use it.")
			...
			.give(Pugmas21QuestItem.RIBBON.get())
		...
		.then()
		.talkTo(Pugmas21NPC.CAPTAIN_NERISSA)
		.gather(Pugmas21QuestItem.RIBBON.get())
		.dialog(dialog -> dialog
			.player(Pugmas21NPC.PANSY + " wanted me to give this to you.")
	...
	HOLIDAY_HEIST_ELVES(GatherQuestTask.builder()
		...
		.dialog(dialog -> dialog
			...
			.npc("" + Dialog.Variable.PLAYER_NAME + ", do you still want to help? If so, why don't you sneak into the pirate headquarters for me! Your mission is to retrieve my recipe and return safely!")
		...
		.complete(dialog -> dialog
			...
			// TODO Sounds
			.npc("Boom! Okay there, a perfect disguise!")
			.give(Pugmas21QuestItem.PIRATE_HAT.get()) // TODO force wearing?
			.player("This looks amazing! Thank you, this is exactly what I needed.")
			.npc("Haha! Well, I'm not known as the best costume designer for nothing.")
			.npc("Do come again!")
		)
		...
		.dialog(dialog -> dialog
			...
			.npc("..Wait.. " + Dialog.Variable.PLAYER_NAME + ", what is that?")
			...
			.npc("Why don't you go give it to our chef, " + Pugmas21NPC.PINE + ", I'm sure she could benefit from it.")
		)
		.then()
		.talkTo(Pugmas21NPC.PINE)
		.gather(Pugmas21QuestItem.PUGMAS_COOKIE_RECIPE.get())
		.dialog(dialog -> dialog
			.npc("Oh, hey new recruit! I didn't expect to see you here. It's nice to meet you, I'm " + Dialog.Variable.NPC_NAME + ".")
			.player("Hi, I'm " + Dialog.Variable.PLAYER_NAME + ". " + Pugmas21NPC.CASSIA + " asked me to give this to you.")
			.npc("Oh, lovely! What is it?")
			.player("It's a pirate dish recipe that I accidentally stol-, I mean stumbled upon while helping around the island. " + Pugmas21NPC.CASSIA + " thought you could use it.")
			.npc("Really!? I love learning new recipes, thank you so much! Pirate recipe.. It reminds me of my sibling " + Pugmas21NPC.PANSY + ".")
			.npc("I'll make sure to perfect this dish! Oh, and you said " + Pugmas21NPC.CASSIA + "? Would you mind bringing this ribbon to them? I heard they were looking for it.")
		...
		.gather(Pugmas21QuestItem.RIBBON.get())
		.dialog(dialog -> dialog
			.player(Dialog.Variable.NPC_NAME + ", I found your-")
			.npc("Eh!? Is that my ribbon? Has it been here this whole time?")
			.player("Yup. " + Pugmas21NPC.PINE + " said you left it in the kitchen this morning...")
	...
	CRYSTAL_REPAIR_2(GatherQuestTask.builder()
		...
		.then()
		.talkTo(Pugmas21Entity.GUARDIAN)
		.dialog(dialog -> dialog
			// The Mysterious Woman suddenly turns into the Guardian, a magnificent crystal reindeer.
			.npc(Pugmas21Entity.GUARDIAN, "The reason I know all of this is because I am the Guardian.")
			.player("Why show yourself now? Will you help me fix the crystal?")
			.npc(Pugmas21Entity.GUARDIAN, "Of course I will. As to why I decided to show myself now? It's because of the joy you have brought me! I haven't had this much fun in centuries! I have greatly enjoyed watching you as you traversed the town, and helped its people solve their problems.")
			.npc(Pugmas21Entity.GUARDIAN, "Now, I think I've had my fun. Let me combined those two shards you have brought me with the one I kept from the explosion")
			...
			.npc(Pugmas21Entity.GUARDIAN, "Hahaha, well where is the fun in that? Now then, here you go. Take those shards to the Pugmas Shrine. I'll be waiting for you there so we can cleanse them of the dark energy.")
			.give(Pugmas21QuestItem.CRYSTAL_PIECE.get())
			.player("Thank you for this!")
			.npc(Pugmas21Entity.GUARDIAN, "Good, you're here. Now let's see if I can remember the ritual... ah, that's right! To rid the crystals of the dark energy, we need three things.")
			.npc(Pugmas21Entity.GUARDIAN, "An emerald from the mountains, a shimmering crystal log from the deepest caves, a rare drop from the magical trees, and the finest wool which has a chance of dropping from the local sheep.")
			.npc(Pugmas21Entity.GUARDIAN, "Once you have all three items, return here and we can begin the ritual.")
		...
		.complete(dialog -> dialog
			...
			.npc(Pugmas21Entity.GUARDIAN, "Now, we merely have to combine the ingredients with the crystal shards in the water here. Its purity will aid in the process of cleaning the crystals and repairing them.")
			.npc(Pugmas21Entity.GUARDIAN, "Chuck everything into the water and watch the magic happen!")
			...
			.npc(Pugmas21Entity.GUARDIAN, "The ritual is complete! Grab the crystal and take it to the central island so that the Crystal can be whole once more.")
			.player("That was amazing! Thank you for all the help.")
			.npc(Pugmas21Entity.GUARDIAN, "It was my absolute pleasure. Go now, and remember, have a Merry Pugmas!")
			.give(Pugmas21QuestItem.CRYSTAL.get())
	...
	PARTY_PANIC(GatherQuestTask.builder()
		...
		.then()
		.talkTo(Pugmas21NPC.EVE)
		.dialog(dialog -> dialog
			.npc("Honk")
			.player("Huh?")
			.npc("My bad, I forgot not everyone speaks penguin.")
			.npc("You must be " + Dialog.Variable.PLAYER_NAME + ", right? We were expecting you.")
		...
		.talkTo(Pugmas21NPC.GLORIA)
		.dialog(dialog -> dialog
			.npc("Welcome back " + Dialog.Variable.PLAYER_NAME + "!")
			...
			.player("Oh wow, thanks " + Dialog.Variable.NPC_NAME + "! I really appreciate that.")
	...
	PENGUIN_MAFIA(InteractQuestTask.builder()
		...
		.dialog(dialog -> dialog
			...
			.player("Uhuh")
			.npc("Hey.. Now that I think about it, you look familiar. Are you " + Dialog.Variable.PLAYER_NAME + "? The one that's been helping everyone repair the crystal and save Pugmas?! Oh, please, won't you help me catch this fish thief as well?")
		...
		.then()
		.talkTo(Pugmas21Entity.FISH_PILE)
		.dialog(dialog -> dialog
