	...
	private static List<Reward> setupDailyRewards(int i) {
		return switch (i) {
			case 1 -> List.of(
				...
				/*  18 */ new Reward("4 Regen 2 Potions")						.item(new ItemBuilder(Material.POTION).amount(4).potionType(PotionType.REGENERATION, false, true)),
				/*  19 */ new Reward("4 Health 2 Potions")					.item(new ItemBuilder(Material.POTION).amount(4).potionType(PotionType.STRONG_HEALING, false, true)),
